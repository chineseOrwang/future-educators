(function($) {
    $.fn.html5lightbox = function(k) {
        ...
        l.createMarkup = function() {
            ...
            /**  标签输出
                #html-lightbox {display:none;top:0px;left:0px;width:100%;height:100%;z-index:9999999;} 原没有
                    #html-lightbox-overlay {
                        display:block;position:absolute;top:0px;left:0px;width:100%;height:100%;background-color:{l.options.overlaybgcolor};
                        opacity:{...};filter:alpha(opacity=Math.roud(...opacity*100))
                    #html-lightbox-box display:block;position:relative;margin:0px auto;overflow:hidden;
                        #html5-elem-box  display:block;position:relative;margin:0px auto;text-align:center;
                            #html5-elem-wrap ........
            */
            l.$lightbox.css({
...
var ASPlatforms = {
    ...
    $.fn.html5zoo = function(G) {       //定义j,j.prototype   
        var H = 0,
        ELEM_SRC = 1,
        ELEM_TITLE = 2,
        ELEM_DESCRIPTION = 3,
        ...
        J.prototype = {     //initData readTags init getParams ... createSliderTimeout createBackgroundImage showImage
            initData: function(a) {
                this.readTags();
                a(this)
            },
            ...
            createMarkup: function() {
                ...
                /** .html5zoo-wrapper-id 
                        .html5zoo-background-image-id 
                        .html5zoo-bottom-shadow-0-id
                        .html5zoo-slider-id
                            .html5zoo-box-id
                                .html5zoo-swipe-box-id
                                    .html5zoo-space-id
                                        无img
                                    .html5zoo-img-box-id
                                        无.html5zoo-img-...
                                            无img
                            .html5zoo-text-wrapper-id
                                无内部标签
                            .html5zoo-play-id
                            .html5zoo-video-wrapper-id
                            .html5zoo-ribbon-id
                            .html5zoo-arrow-left-id
                                无内部
                            .html5zoo-arrow-right
                                无内部
                            .html5zoo-timer-id
                            .html5zoo-watermark-id
                        .html5zoo-nav-id
                            .html5zoo-nav-container-id
                                无内部    
                */
...
})(jQuery); (function($) {             //Transition(html5zooTransition,sliceTransition...)
    $.fn.html5zooTransition = function(a, b, c, d, e, f) {
        //a,b,c,d(名字 时间 效果 方向),e,f
        var g = this;
        var h = d.effect;
        var i = d.duration;
        var j = d.easing;
    ...
    $.fn.sliceTransition = function(b, c,d, e, f, g) {
        ...
        var h = this;
        // var w = h.width();
        var w = parseInt(h.context.style.width);
        var j = Math.ceil(w / e.slicecount);
        d.hide();
        // console.log(h,parseInt(h.context.style.width),w,j,d);
    ...
    $.fn.blindsTransition = function(c, d, e, f, g, h) {
        ...
        var j = this;
        // var w = j.width();
        var w = parseInt(j.context.style.width);
        var k = Math.ceil(w / f.slicecount);
        // console.log(j,w,k);     //100   34
        e.hide();
    ...
    $.fn.threedTransition = function(d, e, f, g, j, k) {
        ...
        var w = parseInt(l.context.style.width),h = parseInt(l.context.style.height);
        var dist = h / 2;
        ...
        f.hide();
        // console.log(l,w,h,"dist:",dist,m,n,"slicecount",g.slicecount);
    ...
    $.fn.shuffleTransition = function(f, g, k, l, m, n) {
        ...
        var w = parseInt(o.context.style.width),h = parseInt(o.context.style.height);
        var p = Math.ceil(w / l.columncount);
        var q = Math.ceil(h / l.rowcount);
        // console.log(o,parseInt(o.context.style.height),w,p,q);
