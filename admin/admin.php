...
<head>
    ...
    <title>鲁大未来教育家协会-管理入口</title>
</head>
<body style='width: 100%;height: 100%;background: url(img/bg.jpg) no-repeat fixed;background-size: 100% 100%;'>
<style>
    * {
        margin: 0;
        padding: 0;
...
<div class="body">
    <h3 style=" text-align: center;" onclick="window.open('../index.php')">鲁大未来教育家协会<br><br>管理入口</h3>
    <form action="admin.php" method="post">
        ...
        <input class="code" type="text"
               ...
               name="code" placeholder="点击图片更换验证码" value="">
        <img style="float: right; width: 80px; height: 35px; margin-top: 35px;" src="../login/inclode/code.php"
             onclick="this.src='inclode/code.php?'+Math.random()"/>
        <div style="clear: both;height: 20px;"></div>
        <button class="btn" type="submit">登 录</button>
        <a href="../index.php" class="btn" style="float: right;display: block;background: rgb(241,241,241);border:1px solid rgb(115,170,162);text-decoration: none;text-align: center;line-height: 35px;">首页</a>
    </form>
</div>
