...
class Page
{
    ...
    function fpage()
    {
        ...
        $html[0] = "<li><span>共<b>{$this->total}</b>{$this->config["head"]}</span></li>";
        $html[1] = "<li><span>本页<b>" . $this->disnum() . "</b>条</span></li>";
        $html[2] = "<li><span>本页从<b>{$this->start()}-{$this->end()}</b>条</span></li>";
        $html[3] = "<li><span>当前在<b>{$this->page}/{$this->pageNum}</b>页</span></li>";
